        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantAreaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRestaurantTable", x => new { x.ReservationsId, x.TablesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationRestaurantTable_RestaurantTables_TablesId",
                        column: x => x.TablesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationRestaurantTable_TablesId",
